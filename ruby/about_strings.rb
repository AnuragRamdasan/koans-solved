...
EOS
    ...
    # we lose the leading '\n' thus dropping length by 1 and making 'I'
    # the first character.
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Ans:
    # << usually tends to be faster than += as += preserves immutability
    # thus creating and entirely new object and assigning value to it
    # whereas << appends to the original object in place.
  end
