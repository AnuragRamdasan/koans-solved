...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    ...
    # the character preceding the '?' is optional
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Ans:
    # A simple * would never fail.
    # Something like 'ab*c' would fail to match 'axc'.
  end
  ...
  # Ans:
  # Repition operators look for the longest possible match.
  # for a sequence 'abbbbbc' with regex 'ab+' it would go all the
  # way till it reaches 'c' to match 'abbbbb'.
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    # /\w+/ matches only words. So it stops as soon as it sees a
    # whitespace and returns variable_1
  end
  ...
  # Ans:
  # Character classes match a range of data while Alternation gets only
  # specific instances.
