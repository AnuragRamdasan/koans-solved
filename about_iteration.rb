...
class AboutIteration < Neo::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    # also known as filter in some languages
    array = [1, 2, 3, 4, 5, 6]
  ...
  def test_inject_will_blow_your_mind
    ...
    # Describe is what most languages describe as reduce or fold if
    # you are really old.
    # It takes a seed element/accumulator and performs operations
    # on each element of the collection and stores it in accumulator
  end
  ...
  # Ans:
  # The first method of using a block for File automatically closes
  # the pointers to the file, preventing any sort of memory leaks.
